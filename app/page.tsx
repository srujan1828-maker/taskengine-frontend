...
// This strictly defines the allowed agent names to prevent TypeScript index errors
type AgentKey = 'lead' | 'content' | 'competitor' | 'workflow';

export default function Home() {
  // Keep track of the user's inputs for each specific agent type
  ...
  // The upgraded Razorpay checkout function
